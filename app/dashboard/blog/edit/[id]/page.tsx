  ...
  const loadPost = async () => {
    try {
      ...
      if (data.published_at) {
        ...
        publishedAtFormatted = date.toISOString().split('T')[0]; // Format: YYYY-MM-DD
      } else {
        // Default to today if no date exists
        publishedAtFormatted = new Date().toISOString().split('T')[0];
      }
      ...
      setFormData({
        ...
        primary_image_title: (data as any).primary_image_title || '',
  ...
  return (
    <div className="min-h-screen bg-black" dir="rtl">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">تعديل الصورة</h1>
          <p className="text-gray-400">قم بتعديل الصورة</p>
        </div>
