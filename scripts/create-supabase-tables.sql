...
CREATE TABLE IF NOT EXISTS teams (
  ...
  candidate_id TEXT,
  candidate_name TEXT,
  members TEXT[], -- Array of member IDs
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- Create function for Arabic-friendly search with word order priority
...
BEGIN
  ...
  ORDER BY 
    -- Priority 1: Exact match at start of name
    ...
    -- Priority 3: Full-text search rank
