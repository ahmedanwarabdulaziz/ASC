...
-- Step 1: Create helper function for SQL execution (if needed)
...
-- Step 2: Create members table with full-text search support
...
-- Step 6: Create function to automatically update search_vector
...
-- Step 7: Create trigger to auto-update search_vector
...
-- Step 8: Create professional search function with word order priority
...
DECLARE
  ...
  query_words TEXT[];
BEGIN
  -- Split query into words for word-order matching
